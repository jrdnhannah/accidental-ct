    ...
    <div id="login-wrapper" class="section-wrapper">
        ...
        <div id="register-form" class="section-wrapper disappear">
            <div id="register-real-name-wrapper">
                <label class="form-label">Real name<input type="text" id="register-real-name-text" />
            </div>
            <div id="register-email-address-wrapper">
                <label class="form-label">Real name<input type="text" id="register-email-address-text" /></label>
            </div>
            <div id="register-password-wrapper">
                <label class="form-label">Real name<input type="text" id="register-password-text" /></label>
            </div>
        </div>
    </div>
@stop